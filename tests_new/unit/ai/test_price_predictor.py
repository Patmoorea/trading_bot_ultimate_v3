...
class TestPricePredictor:
    def test_initialization(self):
        ...
        assert os.path.basename(predictor.model_path) == 'BTC_USDT_1h_model.keras'  # Modifié ici
    ...
    def test_different_timeframes(self):
        ...
        for tf in timeframes:
            ...
            assert os.path.basename(predictor.model_path) == f'BTC_USDT_{tf}_model.keras'  # Modifié ici

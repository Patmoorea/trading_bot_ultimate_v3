...
class OKXExchange:
    def __init__(self, api_key: str, api_secret: str, password: str):
        ...
        Args:
            ...
            password: API password/passphrase required by OKX
        """
    ...
    async def set_position_mode(self, hedged: bool = True) -> bool:
        ...
        Args:
            hedged: True for hedge mode, False for one-way mode
    ...
    async def set_leverage(self, symbol: str, leverage: int, params: Dict = None) -> bool:
        ...
        Args:
            ...
            params: Additional parameters (e.g., marginMode)
        ...
        try:
            await self._exchange.set_leverage(leverage, symbol, params=params)
            return True
        except Exception as e:

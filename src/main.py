...
class StreamlitSessionManager:
    ...
    def __init__(self):
        ...
        self.init_time = datetime.strptime(CURRENT_TIME, "%Y-%m-%d %H:%M:%S")
            ...
            st.session_state.update(
                {
                    ...
                    "ws_last_heartbeat": CURRENT_TIME,
                    # Protections
                    "keep_alive": True,
                    "prevent_cleanup": True,
                    "force_cleanup": False,
...
║ Time: {CURRENT_TIME} UTC
║ Session ID: {self.session_id}
║ Last Action: {st.session_state.get("last_action_time", CURRENT_TIME)}
╚═════════════════════════════════════════════════╝
        """
        )
    ...
    def get_session_info(self):
        ...
        try:
            return {
                ...
                "session_id": self.session_id,
                "init_time": CURRENT_TIME,
                "last_action": st.session_state.get("last_action_time", CURRENT_TIME),
